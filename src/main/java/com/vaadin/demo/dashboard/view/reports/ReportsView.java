...
public final class ReportsView extends TabSheet implements View, CloseHandler,
    ...
    private Component buildDrafts() {
        ...
        allDrafts.setCaption("All Reports");
        ...
        Label draftsTitle = new Label("Reports");
    ...
    private Component buildDraftThumb() {
        ...
        Label draftTitle = new Label("Monthly Popular Stocks<br><span>Last modified 1 day ago</span>", ContentMode.HTML);
        draftTitle.setSizeUndefined();
        draftThumb.addComponent(draftTitle);

        final Button delete = new Button("×");
        delete.setDescription("Delete reports");
    ...
    public void addReport(final ReportType reportType, final Object prefillData) {
        ...
        if (reportType == ReportType.MONTHLY) {
            reportEditor.setTitle("Monthly Popular Stock");
            ...
            reportEditor.setTitle("Unnamed Report – " + (df.format(new Date())) + " (" + getComponentCount() + ")");
